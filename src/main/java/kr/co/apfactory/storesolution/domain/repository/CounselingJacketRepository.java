...
// jpa 사용
@Repository
public interface CounselingJacketRepository extends JpaRepository<CounselingJacket, Long>, CounselingSupportRepository {
    CounselingJacket findByCounselingCommonId(Long id);
}
